...
struct DebugValue_
{
  ...
  _index_type index;
   ...
   typedef int32_t _array_id_type;
...
#endif
#if defined(_WIN32) && defined(TYPE_DEBUG_FLOAT_ARRAY)
  #undef TYPE_DEBUG_FLOAT_ARRAY
#endif
...
struct MD5Sum< ::mavros_msgs::DebugValue_<ContainerAllocator> >
{
  ...
  {
    return "a385507a0141af80b5f68662747f1e68";
  }

  static const char* value(const ::mavros_msgs::DebugValue_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa385507a0141af80ULL;
  static const uint64_t static_value2 = 0xb5f68662747f1e68ULL;
};
...
struct Printer< ::mavros_msgs::DebugValue_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mavros_msgs::DebugValue_<ContainerAllocator>& v)
  {
    ...
    s << indent << "array_id: ";
    Printer<int32_t>::stream(s, indent + "  ", v.array_id);
    s << indent << "name: ";
