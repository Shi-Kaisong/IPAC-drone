...
bool operator==(const ::mavros_msgs::WaypointSetCurrentResponse_<ContainerAllocator1> & lhs, const ::mavros_msgs::WaypointSetCurrentResponse_<ContainerAllocator2> & rhs)
{
