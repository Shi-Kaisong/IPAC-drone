...
rospy.init_node("mavros_communication")
rate = rospy.Rate(10)
...
class Communication:
    ...
    def __init__(self):
        ...
        self.cmd_sub = rospy.Subscriber("/cmd",String,self.cmd_callback,queue_size=3)
        self.cmd_pose_flu_sub = rospy.Subscriber("/cmd_pose_flu", Pose, self.cmd_pose_flu_callback,queue_size=1)
        self.cmd_pose_enu_sub = rospy.Subscriber("/cmd_pose_enu", Pose, self.cmd_pose_enu_callback,queue_size=1)
        self.cmd_vel_flu_sub = rospy.Subscriber("/cmd_vel_flu", Twist, self.cmd_vel_flu_callback,queue_size=1)
        self.cmd_vel_enu_sub = rospy.Subscriber("/cmd_vel_enu", Twist, self.cmd_vel_enu_callback,queue_size=1)
        ''' 
        ros publishers
        '''
        self.target_motion_pub = rospy.Publisher("/mavros/setpoint_raw/local", PositionTarget, queue_size=1)
        ...
        rospy.loginfo("mavros_communication initialized")
    ...
    def cmd_callback(self, msg):
        if msg.data == self.last_cmd or msg.data == '' or msg.data == 'stop controlling':
            ...
            rospy.loginfo(": Armed "+str(self.arm_state))
    ...
    def hover(self):
        ...
        rospy.loginfo(":"+self.flight_mode)
    ...
    def flight_mode_switch(self):
        if self.flight_mode == 'HOVER':
            ...
            rospy.loginfo(": "+self.flight_mode+"failed")
            return False
