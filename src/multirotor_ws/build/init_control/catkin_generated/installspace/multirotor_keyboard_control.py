...
if __name__=="__main__":
    ...
    rospy.init_node('mavros_multirotor_keyboard_control')
    ...
    if control_type == 'vel':
        ...
        leader_cmd_vel_flu_pub = rospy.Publisher("/leader/cmd_vel_flu", Twist, queue_size=1)
        leader_cmd_pub = rospy.Publisher("/leader/cmd", String, queue_size=1)
        ...
        leader_cmd_accel_flu_pub = rospy.Publisher("/leader/cmd_accel_flu", Twist, queue_size=1)
        leader_cmd_pub = rospy.Publisher("/leader/cmd", String, queue_size=3)
